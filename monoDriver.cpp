	...
	*/
...

    {
        ...
        if(!single_run){
            ...
            doQuadTreeVPB(cachedsegtex,basepath,datalist_lod,bounds,calib->left_calib,cached_dir_name,useTextureArray,true,false,osg::BoundingBox(bounds.min_x,bounds.min_y,0,bounds.max_x,bounds.max_y,0));
