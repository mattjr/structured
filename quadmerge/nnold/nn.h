 ...
 */
delaunay* delaunay_build(int np, point_nn points[], int ns, int segments[], int nh, double holes[]);
 ...
 */
void points_thingrid(int* n, point_nn** p, int nx, int ny);
 ...
 */
void points_thinlin(int* n, point_nn** p, double rmax);
 ...
 */
void points_getrange(int n, point_nn points[], double zoom, double* xmin, double* xmax, double* ymin, double* ymax);
 ...
 */
void points_generate(double xmin, double xmax, double ymin, double ymax, int nx, int ny, int* nout, point_nn** pout);
 ...
 */
void points_read(char* fname, int dim, int* n, point_nn** points);
 ...
 */
double points_scaletosquare(int n, point_nn* points);
 ...
 */
void points_scale(int n, point_nn* points, double k);
 ...
 */
void lpi_interpolate_point(lpi* l, point_nn* p);
 ...
 */
void lpi_interpolate_points(int nin, point_nn pin[], int nout, point_nn pout[]);
 ...
 * @param p Point to be interpolated (p->x, p->y -- input; p->z -- output)
 */
void nnpi_interpolate_point(nnpi* nn, point_nn* p);
 ...
 * @param pout Array of output points [nout]
 */
void nnpi_interpolate_points(int nin, point_nn pin[], double wmin, int nout, point_nn pout[]);
 ...
 * @param p Point to be interpolated (p->x, p->y -- input; p->z -- output)
 */
void nnhpi_interpolate(nnhpi* nn, point_nn* p);
 ...
 * @param p New data
 */
void nnhpi_modify_data(nnhpi* nn, point_nn* p);
