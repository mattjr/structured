...
check=$(($COUNT % $2));   
    if [ $check -eq 0 ]  && [ "$COUNT" -gt 0 ];then
        echo "cd $3;/home/mkj/cvs/threadedStereo/threadedStereo /home/mkj/cvs/threadedStereo/ng2_stereo.cfg -f /media//coral/r20071004_013437_gbr_05_noggin_grids/i20071004_013437_cv/ $1 --single-run $LAST $COUNT" >> tscmds
	LAST=$COUNT
    fi
        let COUNT=COUNT+1
done
...
./runvrip.sh
STEREOCONFIG=/home/mkj/cvs/threadedStereo/ng2_stereo.cfg
