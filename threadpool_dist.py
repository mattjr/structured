...
__date__ = "$Date: 2008-10-21 22:42:25 $"
...
class WorkerThread(threading.Thread):
    ...
    def __init__(self, requests_queue, results_queue, execwith,poll_timeout=5, **kwds):
        ...
        while True:
            ...
            try:
                ...
                if self._dismissed.isSet():
                    ...
                    break
                try:
                    request.args.append(self._execwith)
...
class ThreadPool:
    ...
    def createWorkersLocal(self, num_workers, poll_timeout=5):
    ...
    def createWorkersRemote(self, num_workers, machine, poll_timeout=5):
        """Add num_workers worker threads to the pool.
        ...
        """
        runwith = 'ssh %s  ' % machine.rstrip('\n')
        for i in range(num_workers):
            self.workers.append(WorkerThread(self._requests_queue,
                self._results_queue,runwith,  poll_timeout=poll_timeout))

    def createWorkersSLURM(self, num_workers, slurmctrl, host="",title="runtp", poll_timeout=5):
        """Add num_workers worker threads to the pool.
