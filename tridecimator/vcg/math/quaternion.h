...
Revision 1.19  2008/02/22 17:39:59  ponchio
...
Microerror. ($LOG$ -> Revision 1.19  2008/02/22 17:39:59  ponchio
Microerror. ($LOG$ -> ToMatrix returned the inverse matrix. OUCH.
Microerror. ($LOG$ -> This affects trackball and shot.h
Microerror. ($LOG$ -> Added a const also.
Microerror. ($LOG$ ->
