...
namespace OGF {
    ...
    public:
        ...
        virtual AttributeStore* create_attribute_store(OGF::AttributeManager* manager) = 0 ;
    ...
    public:
        ...
        virtual AttributeStore* create_attribute_store(OGF::AttributeManager* manager) {
     ...
     */
    template <class T> class ogf_register_attribute_type {
    public:
    ...
    public:
        ...
        SerializedAttributeRef operator[](RECORD* record) {
