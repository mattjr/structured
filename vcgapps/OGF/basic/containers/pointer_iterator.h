...
#ifndef __OGF_BASIC_POINTER_ITERATOR__
#define __OGF_BASIC_POINTER_ITERATOR__
...
//_________________________________________________________
    ...
    /**
     * PointerIterator makes it possible to iterate on a
     * container of pointers and automatically does the
     * indirections.
     */
    template <class CONTAINER, class T> class PointerIterator {
    public:
...
//_________________________________________________________
    ...
    /**
     * PointerConstIterator makes it possible to iterate on a
     * container of pointers and automatically does the
     * indirections.
     */
    template <class CONTAINER, class T> class PointerConstIterator {
    public:
