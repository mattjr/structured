...
#ifndef __OGF_BASIC_IO_B_STREAM__
#define __OGF_BASIC_IO_B_STREAM__
...
//____________________________________________________________________________
    ...
    const int OGF_LITTLE_ENDIAN = 0; 
    const int OGF_BIG_ENDIAN    = 1; 
 ...
 */
    ...
    public:
        BinaryStream(int stream_endian_in = OGF_BIG_ENDIAN) ;
 ...
 */
    ...
    public:
        BinaryInputStream(
            const std::string& file_name, int endian_in = OGF_BIG_ENDIAN
        );

        BinaryInputStream(
            std::istream& input, int endian_in = OGF_BIG_ENDIAN
        );
 ...
 */
    ...
    public:
        BinaryOutputStream(
            const std::string& file_name, int stream_endian = OGF_BIG_ENDIAN
        );
        BinaryOutputStream(
            std::ostream& output, int stream_endian = OGF_BIG_ENDIAN
        );
