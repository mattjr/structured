...
#ifndef ___MAP_SERIALIZER_OBJ__
#define ___MAP_SERIALIZER_OBJ__
...
//_________________________________________________________
    ...
    class CELLS_API MapSerializer_obj : public MapSerializer {
    public:
...
//_________________________________________________________
     ...
     */
    class CELLS_API MapSerializer_eobj : public MapSerializer_obj {
    public:
        MapSerializer_eobj() ;
        virtual bool serialize_read(
            std::istream& in, AbstractMapBuilder& out
