...
//_________________________________________________________
     ...
     */
    template<> class CELLS_API MapCombelObserver<Map::Vertex> {
    public:
     ...
     */
    template<> class CELLS_API MapCombelObserver<Map::Halfedge> {
    public:
        MapCombelObserver(Map* m) ;
        virtual ~MapCombelObserver() ;
     ...
     */
    template<> class CELLS_API MapCombelObserver<Map::Facet> {
    public:
        MapCombelObserver(Map* m) ;
        virtual ~MapCombelObserver() ;
