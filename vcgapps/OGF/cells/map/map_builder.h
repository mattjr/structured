...
#ifndef __OGF_CELLS_MAP_MAP_BUILDER__
#define __OGF_CELLS_MAP_MAP_BUILDER__
...
//_________________________________________________________
    ...
    class CELLS_API AbstractMapBuilder {
    public:
        ...
        virtual void add_vertex(const Point3d& p) = 0  ;
        virtual void add_tex_vertex(const Point2d& p) = 0  ;

        virtual void add_vertex(unsigned int id, const Point3d& p) = 0 ;
        virtual void add_tex_vertex(unsigned int id, const Point2d& p) = 0 ;
...
//_________________________________________________________
    ...
    class CELLS_API MapBuilder : public AbstractMapBuilder, public MapMutator {
    private:
    ...
    public:
        ...
        virtual void add_tex_vertex(const Point2d& p) ;

        virtual void add_vertex(unsigned int id, const Point3d& p) ;
        virtual void add_tex_vertex(unsigned int id, const Point2d& p) ;
    ...
    protected:
        ...
        void add_vertex_internal(unsigned int id, const Point3d& p) ;
        void add_vertex_internal(const Point3d& p) ;
