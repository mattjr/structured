...
//_________________________________________________________
    ...
    int enumerate_vertices(
        Map* map, Attribute<Map::Vertex, int>& id, int start, int step
    ) {
        ogf_assert(start >= 0) ;
        ogf_assert(step > 0) ;
        ogf_assert(
    ...
    int enumerate_halfedges(
        Map* map, Attribute<Map::Halfedge, int>& id, int start, int step
    ) {
        ogf_assert(start >= 0) ;
        ogf_assert(step > 0) ;
        ogf_assert(
    ...
    int enumerate_facets(
        Map* map, Attribute<Map::Facet, int>& id, int start, int step
    ) {
        ogf_assert(start >= 0) ;
        ogf_assert(step > 0) ;
        ogf_assert(
    ...
    int enumerate_tex_vertices(
        Map* map, Attribute<Map::TexVertex, int>& id, int start, int step
    ) {
        ogf_assert(start >= 0) ;
        ogf_assert(step > 0) ;
        ogf_assert(
