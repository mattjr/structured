...
#include <OGF/basic/containers/pointer_iterator.h>
...
//_________________________________________________________
     ...
     */
    class CELLS_API MapComponent : public Counted {
    public:
...
//_________________________________________________________
     ...
     */
    class CELLS_API MapComponentMutator {
    public:
...
//_________________________________________________________
     ...
     */
    class CELLS_API MapComponentsExtractor : public MapComponentMutator {
    public:
...
//_________________________________________________________
    ...
    namespace Geom {
        ...
        double CELLS_API component_area(const MapComponent* comp) ;

        double CELLS_API component_signed_area2d(const MapComponent* comp) ;
        inline double component_area2d(const MapComponent* comp) {
            return ::fabs(component_signed_area2d(comp)) ;
        }

        double CELLS_API component_border_length(const MapComponent* comp) ;

        Box3d CELLS_API component_bbox(const MapComponent* mapc) ;
        Box2d CELLS_API component_bbox2d(const MapComponent* mapc) ;

        void CELLS_API translate_component(MapComponent* comp, const Vector3d& v) ;
        void CELLS_API translate_component2d(MapComponent* comp, const Vector2d& v) ;

        void CELLS_API normalize_component_tex_coords(MapComponent* comp) ;
