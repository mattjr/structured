...
#ifndef __OGF_MATH_ATTRIBUTES_ATTRIBUTE_ADAPTER__
#define __OGF_MATH_ATTRIBUTES_ATTRIBUTE_ADAPTER__
...
namespace OGF {
    ...
    protected:
        ...
        PrimaryType bind(AttributeManager* manager, const std::string& name) {
            ...
            if(complex_attr_.bind_if_defined(manager, name)) {
                return ATTR_COMPLEX ;
            }
    ...
    private:
        ...
        Attribute<RECORD, Point2d> point2d_attr_ ;
        Attribute<RECORD, Vector2d> vector2d_attr_ ;
        Attribute<RECORD, Point3d> point3d_attr_ ;
        Attribute<RECORD, Vector3d> vector3d_attr_ ;
        Attribute<RECORD, Complex> complex_attr_ ;
     } ;
