...
#ifndef __OGF_MATH_GEOMETRY_ORIENTED_LINE__
#define __OGF_MATH_GEOMETRY_ORIENTED_LINE__
 ...
 */
    template <class FT> class GenericOrientedLine {
    public:
        typedef GenericPoint3d<FT> Point ;
