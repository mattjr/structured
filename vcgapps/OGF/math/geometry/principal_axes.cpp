...
//_________________________________________________________
    ...
    void PrincipalAxes3d::begin_points() {
        nb_points_ = 0 ;
        sum_weights_ = 0 ;
    ...
    void PrincipalAxes3d::end_points() {
        ...
        if(nb_points_ < 4) {
            axis_[0] = Vector3d(1,0,0) ;
            axis_[1] = Vector3d(0,1,0) ;
            axis_[2] = Vector3d(0,0,1) ;
            eigen_value_[0] = 1.0 ;
            eigen_value_[1] = 1.0 ;
            eigen_value_[2] = 1.0 ;
        } else {
    ...
    void PrincipalAxes3d::point(const Point3d& p, double weight) {
...
//_________________________________________________________
    ...
    void PrincipalAxes2d::begin_points() {
        nb_points_ = 0 ;
        sum_weights_ = 0 ;
    ...
    void PrincipalAxes2d::end_points() {
        ...
        //  return the trivial basis.
        if(nb_points_ < 3) {
            axis_[0] = Vector2d(1,0) ;
            axis_[1] = Vector2d(0,1) ;
            eigen_value_[0] = 1.0 ;
            eigen_value_[1] = 1.0 ;
        } else {
            double x = center_[0] ;
            ...
            MatrixUtil::semi_definite_symmetric_eigen(M_, 2, eigen_vectors, eigen_value_) ;
            
            axis_[0] = Vector2d(eigen_vectors[0], eigen_vectors[1]) ;
            axis_[1] = Vector2d(eigen_vectors[2], eigen_vectors[3]) ;
    ...
    void PrincipalAxes2d::point(const Point2d& p, double weight) {
