...
#ifndef __OGF_MATH_NUMERIC_SYSTEM_SOLVER_CHOLMOD__
#define __OGF_MATH_NUMERIC_SYSTEM_SOLVER_CHOLMOD__
...
namespace OGF {
    ...
    class MATH_API SystemSolverCholmod : public SystemSolver {
    public:
        SystemSolverCholmod() ;
        virtual ~SystemSolverCholmod() ;
