...
#ifndef ___MAP_SERIALIZER_ABF__
#define ___MAP_SERIALIZER_ABF__
...
//_________________________________________________________
    ...
    class PARAMETERIZER_API MapSerializer_abf : public MapSerializer {
    public:
...
//_________________________________________________________
    ...
    class PARAMETERIZER_API MapSerializer_fl : public MapSerializer {
    public:
        MapSerializer_fl() ;
