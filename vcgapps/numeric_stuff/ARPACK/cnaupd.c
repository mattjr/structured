/* cnaupd.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int cnaupd_(ido, bmat, n, which, nev, tol, resid, ncv, v, 
	ldv, iparam, ipntr, workd, workl, lworkl, rwork, info, bmat_len, 
	which_len)
integer *ido;
char *bmat;
integer *n;
...
==========\002,/5x,\002= Complex implicit Arnoldi update code      =\002,/5x,\
\002= Version Number: \002,\002 2.3\002,21x,\002 =\002,/5x,\002= Version Dat\
...
/* Computing 2nd power */
	...
	for (j = 1; j <= i__1; ++j) {
	    i__2 = j;
	    workl[i__2].r = (float)0., workl[i__2].i = (float)0.;
/* L10: */
	}
