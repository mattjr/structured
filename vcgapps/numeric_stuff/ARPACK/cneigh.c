/* cneigh.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int cneigh_(rnorm, n, h__, ldh, ritz, bounds, q, ldq, workl, 
	rwork, ierr)
real *rnorm;
integer *n;
complex *h__;
...
integer *ierr;
{
    ...
    static real temp;
    static integer j;
    extern /* Subroutine */ int ccopy_(), cmout_(), cvout_();
    static real t0, t1;
    extern doublereal scnrm2_();
    static complex vl[1];
    extern /* Subroutine */ int csscal_(), clahqr_(), clacpy_();
    static logical select[1];
    static integer msglvl;
    extern /* Subroutine */ int ctrevc_(), second_(), claset_();
