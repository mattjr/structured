/* dnapps.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int dnapps_(n, kev, np, shiftr, shifti, v, ldv, h__, ldh, 
...
doublereal *workl, *workd;
{
    ...
    extern /* Subroutine */ int dgemv_(), dcopy_(), daxpy_(), dmout_(), 
	    dvout_();
    static real t0, t1;
    ...
    extern /* Subroutine */ int dlacpy_(), dlaset_(), dlartg_();
