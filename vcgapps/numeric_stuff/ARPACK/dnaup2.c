/* dnaup2.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int dnaup2_(ido, bmat, n, which, nev, np, tol, resid, mode, 
...
ftnlen which_len;
{
    ...
    extern /* Subroutine */ int ivout_(), dgetv0_();
    extern doublereal dlapy2_(), dlamch_();
    static integer kp[4];
    extern /* Subroutine */ int dneigh_();
    ...
    extern /* Subroutine */ int dnaitr_(), dnconv_(), dngets_(), dnapps_(), 
	    dsortc_();
    static integer nev0;
