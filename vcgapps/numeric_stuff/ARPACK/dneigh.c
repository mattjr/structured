/* dneigh.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int dneigh_(rnorm, n, h__, ldh, ritzr, ritzi, bounds, q, ldq,
	 workl, ierr)
doublereal *rnorm;
integer *n;
doublereal *h__;
...
integer *ierr;
{
    ...
    extern /* Subroutine */ int dgemv_(), dmout_(), dvout_();
    static real t0, t1;
    extern doublereal dlapy2_();
    static doublereal vl[1];
    extern /* Subroutine */ int dlaqrb_(), second_();
    static logical select[1];
    static integer msglvl;
    extern /* Subroutine */ int dlacpy_(), dtrevc_();
