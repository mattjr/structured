/* dneupd.f -- translated by f2c (version 19991025).
...
/* ----------------------------------------------------------------------- */
/* Subroutine */ int dneupd_(rvec, howmny, select, dr, di, z__, ldz, sigmar, 
...
ftnlen which_len;
{
    ...
    extern /* Subroutine */ int dtrmm_(), dmout_();
    static integer iwork[1];
    static doublereal rnorm;
    static integer ritzi;
    extern /* Subroutine */ int dvout_();
    static integer ritzr;
    extern /* Subroutine */ int ivout_(), dgeqr2_();
    ...
    static integer iheigr, bounds, invsub, iuptri, msglvl, outncv, ishift, 
	    numcnv;
    extern /* Subroutine */ int dlacpy_(), dlahqr_(), dlaset_(), dtrevc_(), 
	    dtrsen_(), dngets_();
