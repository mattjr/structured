...
/* ----------------------------------------------------------------------- */
/* Subroutine */ int dseupd_(rvec, howmny, select, d__, z__, ldz, sigma, bmat,
...
ftnlen which_len;
{
    ...
    extern /* Subroutine */ int dvout_(), ivout_(), dgeqr2_();
    static doublereal bnorm2;
    extern /* Subroutine */ int dorm2r_();
    static integer ih, jj;
    extern doublereal dlamch_();
    static integer iq, np, iw, bounds, msglvl, ishift, numcnv;
    extern /* Subroutine */ int dlacpy_(), dsesrt_(), dsteqr_(), dsortr_(), 
	    dsgets_();
