/* sgetv0.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int sgetv0_(ido, bmat, itry, initv, n, j, v, ldv, resid, 
...
ftnlen bmat_len;
{
    ...
    extern /* Subroutine */ int svout_();
    static real rnorm0;
    static integer jj;
    extern /* Subroutine */ int second_();
    static integer msglvl;
    extern /* Subroutine */ int slarnv_();
