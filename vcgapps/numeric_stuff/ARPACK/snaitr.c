/* snaitr.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int snaitr_(ido, bmat, n, k, np, nb, resid, rnorm, v, ldv, 
...
ftnlen bmat_len;
{
    ...
    static real wnorm, t0, t1, t2, t3, t4, t5;
    extern /* Subroutine */ int saxpy_(), smout_(), ivout_(), svout_(), 
	    sgetv0_();
    static real rnorm1;
    static integer jj;
    extern /* Subroutine */ int slabad_();
    extern doublereal slamch_();
    extern /* Subroutine */ int second_(), slascl_();
