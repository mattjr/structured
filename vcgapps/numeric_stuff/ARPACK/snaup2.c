/* snaup2.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int snaup2_(ido, bmat, n, which, nev, np, tol, resid, mode, 
...
ftnlen which_len;
{
    ...
    extern /* Subroutine */ int ivout_(), smout_(), svout_(), sgetv0_();
    extern doublereal slapy2_();
    static integer kp[4], nevbef;
    ...
    extern /* Subroutine */ int snaitr_(), snconv_(), sneigh_(), sngets_(), 
	    snapps_(), ssortc_();
    static integer nev0;
