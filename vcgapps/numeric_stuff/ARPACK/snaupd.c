/* snaupd.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int snaupd_(ido, bmat, n, which, nev, tol, resid, ncv, v, 
	ldv, iparam, ipntr, workd, workl, lworkl, info, bmat_len, which_len)
integer *ido;
char *bmat;
integer *n;
char *which;
...
vergence testing          = \002,f12.6,/5x,\002Total time in computing final\
 Ritz vectors = \002,f12.6/)";
    ...
    /* Local variables */
    static integer mode, ierr, iupd, next, j, ritzi;
    static real t0, t1;
    static integer ritzr;
    extern /* Subroutine */ int ivout_(), svout_(), snaup2_();
