/* snconv.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int snconv_(n, ritzr, ritzi, bounds, tol, nconv)
integer *n;
real *ritzr, *ritzi, *bounds, *tol;
integer *nconv;
{
    ...
    static integer i__;
    static real t0, t1;
    extern doublereal slapy2_(), slamch_();
