/* sneigh.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int sneigh_(rnorm, n, h__, ldh, ritzr, ritzi, bounds, q, ldq,
	 workl, ierr)
real *rnorm;
integer *n;
real *h__;
integer *ldh;
real *ritzr, *ritzi, *bounds, *q;
integer *ldq;
real *workl;
integer *ierr;
{
    ...
    static integer i__, iconj;
    extern /* Subroutine */ int sscal_(), sgemv_();
    static real t0, t1;
    extern /* Subroutine */ int smout_(), svout_();
    extern doublereal slapy2_();
    static real vl[1];
    extern /* Subroutine */ int second_();
    static logical select[1];
    static integer msglvl;
    extern /* Subroutine */ int slacpy_(), slaqrb_(), strevc_();
...
/*     %------------------------------------------------% */
	...
	if ((r__1 = ritzi[i__], dabs(r__1)) <= (float)0.) {
