/* ssaitr.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int ssaitr_(ido, bmat, n, k, np, mode, resid, rnorm, v, ldv, 
...
ftnlen bmat_len;
{
    ...
    extern /* Subroutine */ int ivout_(), svout_(), sgetv0_();
    static real rnorm1;
    static integer jj;
