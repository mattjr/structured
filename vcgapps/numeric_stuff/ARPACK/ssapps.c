/* ssapps.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int ssapps_(n, kev, np, shift, v, ldv, h__, ldh, resid, q, 
	ldq, workd)
integer *n, *kev, *np;
real *shift, *v;
integer *ldv;
