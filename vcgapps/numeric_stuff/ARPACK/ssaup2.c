/* ssaup2.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int ssaup2_(ido, bmat, n, which, nev, np, tol, resid, mode, 
...
ftnlen which_len;
{
    ...
    static real rnorm;
    extern /* Subroutine */ int scopy_(), sswap_();
    ...
    extern /* Subroutine */ int ssaitr_(), ssconv_(), sseigt_(), ssgets_(), 
	    ssapps_(), ssortr_();
    static integer nev0;
