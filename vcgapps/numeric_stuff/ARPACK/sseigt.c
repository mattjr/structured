/* sseigt.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int sseigt_(rnorm, n, h__, ldh, eig, bounds, workl, ierr)
real *rnorm;
integer *n;
real *h__;
integer *ldh;
real *eig, *bounds, *workl;
integer *ierr;
{
    ...
    static real t0, t1;
    extern /* Subroutine */ int svout_(), second_();
    static integer msglvl;
    extern /* Subroutine */ int sstqrb_();
