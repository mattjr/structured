/* ssgets.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int ssgets_(ishift, which, kev, np, ritz, bounds, shifts, 
	which_len)
integer *ishift;
char *which;
integer *kev, *np;
real *ritz, *bounds, *shifts;
ftnlen which_len;
{
    ...
    extern /* Subroutine */ int sswap_(), scopy_();
    static real t0, t1;
    extern /* Subroutine */ int ivout_(), svout_(), second_();
    static integer msglvl;
    extern /* Subroutine */ int ssortr_();
