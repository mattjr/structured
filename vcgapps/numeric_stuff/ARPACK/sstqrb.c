/* sstqrb.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int sstqrb_(n, d__, e, z__, work, info)
integer *n;
real *d__, *e, *z__, *work;
integer *info;
{
    ...
    extern /* Subroutine */ int slae2_();
    static real b, c__, f, g;
    static integer i__, j, k, l, m;
    static real p, r__, s, anorm;
    extern /* Subroutine */ int slasr_();
    static integer l1, lendm1, lendp1;
    extern /* Subroutine */ int slaev2_();
    extern doublereal slapy2_();
    static integer ii, mm, iscale;
    extern doublereal slamch_();
    static real safmin, safmax;
    extern /* Subroutine */ int slascl_();
    static integer lendsv;
    extern /* Subroutine */ int slartg_();
    static real ssfmin;
    static integer nmaxit, icompz;
    static real ssfmax;
    extern doublereal slanst_();
...
/* Computing 2nd power */
    ...
    safmax = (float)1. / safmin;
    ssfmax = sqrt(safmax) / (float)3.;
...
/*        inner loop */
	...
	for (i__ = m; i__ <= i__1; ++i__) {
	    ...
	    g = d__[i__] - p;
	    r__ = (d__[i__ + 1] - g) * s + c__ * (float)2. * b;
	    p = s * r__;
	    d__[i__] = g + p;
	    g = c__ * r__ - b;
