/* zgetv0.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int zgetv0_(ido, bmat, itry, initv, n, j, v, ldv, resid, 
...
ftnlen bmat_len;
{
    ...
    extern /* Subroutine */ int zgemv_(), dvout_();
    static real t0, t1, t2, t3;
    extern /* Subroutine */ int zcopy_(), zvout_();
    extern doublereal dlapy2_(), dznrm2_();
    static doublereal rnorm0;
    static integer jj;
    extern /* Subroutine */ int second_();
    static integer msglvl;
    extern /* Subroutine */ int zlarnv_();
