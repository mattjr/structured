/* znaitr.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int znaitr_(ido, bmat, n, k, np, nb, resid, rnorm, v, ldv, 
...
ftnlen bmat_len;
{
    ...
    extern /* Subroutine */ int second_(), zdscal_();
    static logical rstart;
    static integer msglvl;
    static doublereal smlnum;
    extern doublereal zlanhs_();
    extern /* Subroutine */ int zlascl_();
