/* znapps.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int znapps_(n, kev, np, shift, v, ldv, h__, ldh, resid, q, 
	ldq, workl, workd)
integer *n, *kev, *np;
doublecomplex *shift, *v;
integer *ldv;
doublecomplex *h__;
integer *ldh;
doublecomplex *resid, *q;
integer *ldq;
doublecomplex *workl, *workd;
{
    /* Initialized data */
    ...
    /* Local variables */
    static integer iend;
    static doublereal unfl, ovfl, c__;
    static doublecomplex f, g;
    static integer i__, j;
    static doublecomplex r__, s, t, sigma;
    extern /* Subroutine */ int zscal_(), zgemv_();
    static real t0, t1;
    extern /* Subroutine */ int zcopy_(), zaxpy_(), ivout_(), zmout_(), 
	    zvout_();
    ...
    extern /* Subroutine */ int zlacpy_(), zlartg_(), zlaset_();
