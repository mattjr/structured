/* znaup2.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int znaup2_(ido, bmat, n, which, nev, np, tol, resid, mode, 
	iupd, ishift, mxiter, v, ldv, h__, ldh, ritz, bounds, q, ldq, workl, 
	ipntr, workd, rwork, info, bmat_len, which_len)
integer *ido;
char *bmat;
integer *n;
char *which;
...
ftnlen which_len;
{
    ...
    extern /* Subroutine */ int zcopy_(), ivout_(), zmout_(), zvout_();
    extern doublereal dlapy2_(), dznrm2_();
    extern /* Subroutine */ int zgetv0_();
    ...
    extern /* Subroutine */ int znaitr_(), zneigh_(), zngets_(), znapps_(), 
	    zsortc_();
