/* zneigh.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int zneigh_(rnorm, n, h__, ldh, ritz, bounds, q, ldq, workl, 
	rwork, ierr)
doublereal *rnorm;
integer *n;
doublecomplex *h__;
...
integer *ierr;
{
    ...
    static integer j;
    static real t0, t1;
    extern /* Subroutine */ int zcopy_(), zmout_(), zvout_();
    extern doublereal dznrm2_();
    static doublecomplex vl[1];
    extern /* Subroutine */ int second_();
    static logical select[1];
    static integer msglvl;
    extern /* Subroutine */ int zlacpy_(), zlahqr_(), ztrevc_(), zdscal_(), 
	    zlaset_();
