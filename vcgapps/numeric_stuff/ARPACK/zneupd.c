/* zneupd.f -- translated by f2c (version 19991025).
...
ftnlen which_len;
{
    ...
    static integer ritz, j, k, iheig, ihbds;
    ...
    extern /* Subroutine */ int zgeru_(), zcopy_(), ztrmm_(), ivout_(), 
	    zmout_(), zvout_();
    ...
    extern /* Subroutine */ int zlacpy_(), zlahqr_(), zngets_(), zlaset_(), 
	    ztrsen_(), ztrevc_(), zdscal_();
