/* zngets.f -- translated by f2c (version 19991025).
...
/* Subroutine */ int zngets_(ishift, which, kev, np, ritz, bounds, which_len)
integer *ishift;
char *which;
integer *kev, *np;
doublecomplex *ritz, *bounds;
ftnlen which_len;
{
    ...
    /* Local variables */
    static real t0, t1;
    extern /* Subroutine */ int ivout_(), zvout_(), second_();
    static integer msglvl;
    extern /* Subroutine */ int zsortc_();
