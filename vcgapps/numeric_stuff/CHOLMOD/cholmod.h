...
/* -----------------------------------------------------------------------------
 * CHOLMOD/Include/cholmod.h.  Version 1.0.
...
#include <numeric_stuff/CHOLMOD/cholmod_config.h>

/* CHOLMOD always includes the Core module. */
#include <numeric_stuff/CHOLMOD/cholmod_core.h>

#ifndef NCHECK
#include <numeric_stuff/CHOLMOD/cholmod_check.h>
#endif

#ifndef NCHOLESKY
#include <numeric_stuff/CHOLMOD/cholmod_cholesky.h>
#endif

#ifndef NMATRIXOPS
#include <numeric_stuff/CHOLMOD/cholmod_matrixops.h>
#endif

#ifndef NMODIFY
#include <numeric_stuff/CHOLMOD/cholmod_modify.h>
#endif

#ifndef NPARTITION
#include <numeric_stuff/CHOLMOD/cholmod_partition.h>
#endif

#ifndef NSUPERNODAL
#include <numeric_stuff/CHOLMOD/cholmod_supernodal.h>
#endif
