...
/* -----------------------------------------------------------------------------
 * CHOLMOD/Cholesky Module.  Version 1.0.  Copyright (C) 2005, Timothy A. Davis
...
)
{
    ...
    /* BUG in version 1.0. Was:
    CHOLMOD(allocate_work) (n, 6*n, 0, Common) ;
    now fixed in version 1.0.1: */
    CHOLMOD(allocate_work) (n, MAX (6*n, A->ncol), 0, Common) ;
