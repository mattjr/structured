...
/* -----------------------------------------------------------------------------
 * CHOLMOD/Partition Module.  Version 1.0.
...
)
{
	...
	*Work3n ;
	...
	ok, nd_compress, nd_camd, csize, jnext /* , good_sepsize */ ;
    cholmod_sparse *B, *C ;
    DEBUG (Int cnt) ;
	...
	/* good_sepsize = 6 * sqrt ((double) cn) ; */

	if (sepsize == cn || sepsize == 0 /* || sepsize > good_sepsize */ )
	{
