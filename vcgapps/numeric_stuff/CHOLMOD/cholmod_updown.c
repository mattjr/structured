...
/* -----------------------------------------------------------------------------
 * CHOLMOD/Modify Module.  Version 1.0.
...
{
    return (CHOLMOD(updown_mark) (update, C, NULL, L, NULL, NULL, Common)) ;
}
...
{
    return (CHOLMOD(updown_mark) (update, C, NULL, L, X, DeltaB, Common)) ;
}
...
#define WDIM 1
#include "generic/t_cholmod_updown.inc"
#define WDIM 2
#include "generic/t_cholmod_updown.inc"
#define WDIM 4
#include "generic/t_cholmod_updown.inc"
