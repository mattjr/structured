...
/* Fixes to be able to compile numeric_stuff with two versions of COLAMD */
#define colamd_recommended colamd98_recommended
#define colamd_set_defaults colamd98_set_defaults
#define colamd colamd98
