 ...
 */
    /* Local working arrays */
    /* 
     * Fix from James Gregson (UBC): initialize all pointers to NULL, to avoid
     * warnings from VisualC++ runtime
     */
    NCPformat *Astore = NULL ;
    int       *iperm_r = NULL; /* inverse of perm_r;
			   used when options->Fact == SamePattern_SameRowPerm */
    int       *iperm_c = NULL ; /* inverse of perm_c */
    int       *iwork = NULL ;
    double    *dwork = NULL ;
    int	      *segrep = NULL, *repfnz = NULL, *parent = NULL, *xplore = NULL;
    int	      *panel_lsub = NULL ; /* dense[]/panel_lsub[] pair forms a w-wide SPA */
    int	      *xprune = NULL ;
    int	      *marker = NULL ;
    double    *dense = NULL, *tempv = NULL;
    int       *relax_end = NULL;
    double    *a = NULL ;
    int       *asub = NULL ;
    int       *xa_begin = NULL, *xa_end = NULL;
    int       *xsup = NULL, *supno = NULL;
    int       *xlsub = NULL, *xlusup = NULL, *xusub = NULL;
    int       nzlumax;
