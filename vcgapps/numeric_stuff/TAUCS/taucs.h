...
#include <numeric_stuff/TAUCS/taucs_config_tests.h>
#include <numeric_stuff/TAUCS/taucs_config_build.h>
...
/* [Bruno] */
#elif defined(TAUCS_BLAS_F2C)
#define taucs_blas_name(x) (f2c_##x)
#else
...
/* [Bruno] #define taucs_potrf taucs_blas_name(dpotrf) */
#define taucs_potrf dpotrf_
/* [Bruno] #define taucs_getrf taucs_blas_name(dgetrf) */
#define taucs_getrf dgetrf_
