...
typedef	SimpleTempData<CMeshO::VertContainer, std::vector<std::pair<vcg::TexCoord2f ,Quadric5<double> > > > Quadric5Temp;
...
class QuadricTexHelper
	  ...
	  static math::Quadric<double> &Qd3(CVertexO &v) {return TD3()[v];}
          ...
          static std::vector<std::pair<vcg::TexCoord2f ,Quadric5<double> > > &Vd(CVertexO *v){return (TD()[*v]);}
